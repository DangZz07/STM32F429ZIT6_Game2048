    ...
    flexButtonCallback(this, &Screen5x5ViewBase::flexButtonCallbackHandler)
{
    ...
    tile5x52_4.setXY(0, 128);
    add(tile5x52_4);

    tile5x52_5.setXY(48, 80);
    add(tile5x52_5);
    ...
    textArea1.setTypedText(touchgfx::TypedText(T___SINGLEUSE_1E62));
    add(textArea1);

    textArea2_1.setXY(145, 48);
    textArea2_1.setColor(touchgfx::Color::getColorFromRGB(0, 0, 0));
    textArea2_1.setLinespacing(0);
    textArea2_1.setTypedText(touchgfx::TypedText(T___SINGLEUSE_LY3Z));
    add(textArea2_1);
...
{
    tile5x52_4.initialize();
    tile5x52_5.initialize();
