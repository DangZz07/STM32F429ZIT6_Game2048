    ...
    flexButtonCallback(this, &Screen5x5_superMergingViewBase::flexButtonCallbackHandler)
{
    ...
    flexButton1_1_1.setBoxWithBorderPosition(0, 0, 132, 30);
    ...
    flexButton1_1_1.setPosition(48, 42, 132, 30);
    add(flexButton1_1_1);
    ...
    textArea2_1_1.setXY(98, 52);
    textArea2_1_1.setColor(touchgfx::Color::getColorFromRGB(0, 0, 0));
    textArea2_1_1.setLinespacing(0);
    textArea2_1_1.setTypedText(touchgfx::TypedText(T___SINGLEUSE_SV2C));
    add(textArea2_1_1);
    ...
    textArea1.setTypedText(touchgfx::TypedText(T___SINGLEUSE_V7OD));
    add(textArea1);
